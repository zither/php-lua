...
PHP_MINIT_FUNCTION(lua) {
	...
	lua_object_handlers.write_property = (zend_object_write_property_t)php_lua_write_property;
	lua_object_handlers.read_property  = (zend_object_read_property_t)php_lua_read_property;
